#ifndef FERRUM_LIBNAR_DMC_TM_VARIATIONAL_TCC_
#define FERRUM_LIBNAR_DMC_TM_VARIATIONAL_TCC_
...
namespace ferrum {
  ...
  RecordType
  DMCTMVariational::populate_obs_lists(const minsky::CountList& doc_multi,
					std::vector<int>& wid,
