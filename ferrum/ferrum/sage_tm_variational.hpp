#ifndef FERRUM_LIBNAR_SAGE_TM_VARIATIONAL_HPP_
#define FERRUM_LIBNAR_SAGE_TM_VARIATIONAL_HPP_
...
namespace ferrum {
   ...
   */
  class SageTMVariational {
  private:
    typedef minsky::SimpleDoc DType;
    typedef SageInitializer DiscreteVariationalInitializer;
    typedef std::vector< double > Vector1D;
    typedef SageTopic< Vector1D > STopicType;
  ...
  public:
    ...
    SageTMVariational();
    SageTMVariational(int nt, const std::vector<double>& usage_h,const std::vector<double>& word_h);
    SageTMVariational(int nt, int vsize, double usage_h, double word_h);
    ~SageTMVariational();
